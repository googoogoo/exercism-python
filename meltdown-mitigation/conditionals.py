...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    return bool(temperature < 800 and neutrons_emitted > 500 and neutrons_emitted * temperature < 500000)
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if ((temperature * neutrons_produced_per_second * 100) / threshold) < 90:
        return 'LOW'
    if ((temperature * neutrons_produced_per_second * 100) / threshold) >= 90 and ((temperature * neutrons_produced_per_second * 100) / threshold) <= 110:
        return 'NORMAL'
    else:
        return 'DANGER'
